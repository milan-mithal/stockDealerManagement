										...
										<div class="card-body">
											<div class="table-responsive">
												<table class="table editable-table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                                    ...
                                                    <button id="button" class="btn btn-danger-gradient mb-4 data-table-btn" data-bs-target="#modalInput" data-bs-toggle="modal" href="javascript:void(0)">Place Order</button>
                                                ...
                                                @if (count($allCartList) > 0)
                                                    <button id="button" class="btn btn-danger-gradient mt-4 mb-4 data-table-btn" data-bs-target="#modalInput" data-bs-toggle="modal" href="javascript:void(0)">Place Order</button>
                                                    <p><a href="{{ route('subdealer.index') }}">Click here </a> to add more product in order list</p>
                                                    @else
                                                    <p><a href="{{ route('subdealer.index') }}">Click here </a> to add products in order list</p>
                                                    @endif
											</div>
										</div>
									</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" name="frm" id="frm" action="{{ route('subdealerorder.create') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="form-label text-muted">Are You Sure Want to Place Order?</label>
                    </div>

                
                <div class="modal-footer">
                    <button type="submit" name="submit" id="submit" class="btn btn-primary-gradient">Yes</button>
