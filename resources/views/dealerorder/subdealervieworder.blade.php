                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                                ...
                                <table class="table table-bordered table-hover mb-0 text-nowrap border-bottom">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="text-muted">Category: {{ $orderProductList->product_category}},<br/> Product Name: {{ $orderProductList->product_name}}, <br/>Size: {{ $orderProductList->product_size}}</div>
                                        </td>
                        ...
                        <div class="card-footer text-end">
                            ...
                            <button type="button" class="btn btn-primary-gradient" onclick="javascript:location.href='{{ route('dealerorder.subdealerorderacceptedstatus',$orderDetails->id) }}'"><i class="fe fe-check"></i> Accept Order</button>
                            @endif
                            @if ($orderDetails->order_status != 'cancelled')
                            <button type="button" class="btn btn-danger-gradient" onclick="javascript:location.href='{{ route('dealerorder.subdealerordercancelstatus',$orderDetails->id) }}'"><i class="fe fe-x"></i> Cancel Order</button>
                            @endif
                            @if ($orderDetails->order_placed == 'No')
                            <button type="button" class="btn btn-success-gradient" onclick="javascript:location.href='{{ route('dealerorder.subdealerplaceorder',$orderDetails->order_id) }}'"><i class="fe fe-upload"></i> Place Order</button>
                            @endif
