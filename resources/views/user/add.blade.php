												...
												<div class="d-flex flex-column">
                                                    <form method="post" name="frm" id="frm" action="{{ route('user.store') }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="dealer_name" id="dealer_name" value="{{ old('dealer_name') }}">
                                                            @error('dealer_name')
                                                              <div class="invalid-feedback block">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="community" id="community" value="{{ old('community') }}">
                                                            @error('community')
                                                            <div class="invalid-feedback block">{{ $message }}</div>
                                                            @enderror
                                                        </div>
