            ...
            <div class="page-header">
                ...
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">View Sub Dealers</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
												...
												<table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
													<thead>
														<tr>
                                                            ...
                                                            <th class="wd-20p border-bottom-0">Dealer Name</th>
															<th class="wd-15p border-bottom-0">Sub Dealer Name</th>
													...
													<tbody>
														...
														<tr>
                                                            ...
                                                            <td>{{ ucfirst($userDetails->maindealer_name) }}</td>
