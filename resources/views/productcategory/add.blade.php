                    ...
                    <div class="col-lg-12 col-md-">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <p class="text-muted">Here you can create product category</p>

                                <div class="d-flex flex-column">
                                    <form method="post" name="frm" id="frm"
                                        action="{{ route('productcategory.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="main_category_name" id="main_category_name">
                                                ...
                                                @foreach (App\Enums\MainCategoryEnums::values() as $key => $value)
                                                    <option value="{{ $key }}" @selected(old('main_category_name') == $key)>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
