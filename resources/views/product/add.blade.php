                                                    ...
                                                    <form method="post" name="frm" id="frm" action="{{ route('product.store') }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="product_category" id="product_category">
                                                                ...
                                                                <option value="Jute Bag" @selected(old('product_category') == 'Jute Bag')>Jute bag</option>
                                                                <option value="Cotton Bag" @selected(old('product_category') == 'Cotton Bag')>Cotton bag</option>
                                                              </select>
