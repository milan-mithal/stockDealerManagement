                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column">
                                    <form method="post" name="frm" id="frm"
                                        action="{{ route('product.update', $productDetail->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="main_category" id="main_category">
                                                ...
                                                @foreach (App\Enums\MainCategoryEnums::values() as $key => $value)
                                                    <option value="{{ $key }}" @selected(old('main_category', $productDetail->main_category) == $key)>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('main_category')
                                            ...
                                            <select class="form-control" name="product_category" id="product_category">
                                                ...
                                                @foreach ($allProductCategoryList as $productCategoryDetails)
                                                    <option
                                                        ...
                                                        @selected(old('product_category', $productDetail->product_category) == $productCategoryDetails->id)>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="product_code" id="product_code"
                                                value="{{ old('product_code', $productDetail->product_code) }}">
                                            @error('product_code')
                                                <div class="invalid-feedback block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control file-input" type="file" id="product_image"
                                                name="product_image">
                                            <input type="hidden" id="old_product_image" name="old_product_image"
                                                value="{{ $productDetail->product_image }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="product_size" id="product_size"
                                                value="{{ old('product_size', $productDetail->product_size) }}">
                                            @error('product_size')
                                                <div class="invalid-feedback block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="product_price"
                                                id="product_price"
                                                value="{{ old('product_price', $productDetail->product_price) }}">
                                            @error('product_price')
                                                <div class="invalid-feedback block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="percentage" id="percentage"
                                                value="{{ old('percentage', $productDetail->percentage) }}">
                                            @error('percentage')
                                                <div class="invalid-feedback block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group input-group align-items-center">
                                            ...
                                            <input type="number" name="length" id="length" class="form-control"
                                                ...
                                                value="{{ old('length', $productDetail->length) }}" />
                                            @error('length')
                                            ...
                                            <input type="number" name="width" id="width" class="form-control"
                                                ...
                                                value="{{ old('width', $productDetail->width) }}" />
                                            @error('width')
                                                <span class="invalid-feedback block">{{ $message }}</span>
                                            @enderror
                                            <span class="input-group-addon">X</span>
                                            <input type="number" name="height" id="height" class="form-control"
                                                ...
                                                value="{{ old('height', $productDetail->height) }}" />
                                            @error('height')
                                                <span class="invalid-feedback block">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="qty_per_box"
                                                id="qty_per_box"
                                                value="{{ old('height', $productDetail->qty_per_box) }}">
                                            @error('qty_per_box')
                                                <div class="invalid-feedback block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="weight_per_box"
                                                id="weight_per_box"
                                                value="{{ old('height', $productDetail->weight_per_box) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                ...
                                                @foreach (App\Enums\CommonStatusEnums::values() as $key => $value)
                                                    <option value="{{ $key }}" @selected(old('status', $productDetail->status) == $key)>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('status')
