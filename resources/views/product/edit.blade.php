												...
												<div class="d-flex flex-column">
                                                    <form method="post" name="frm" id="frm" action="{{ route('product.update', $productDetail->id) }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group input-group align-items-center">
                                                            ...
                                                            <input type="number" name="length" id="length" class="form-control" placeholder="Length (cm)" value="{{ old('length', $productDetail->length) }}"/>
                                                            @error('length')
                                                            <span class="invalid-feedback block">{{ $message }}</span>
                                                            @enderror
                                                            <span class="input-group-addon">X</span>
                                                            <input type="number" name="width" id="width" class="form-control" placeholder="Width (cm)" value="{{ old('width', $productDetail->width) }}"/>
                                                            @error('width')
                                                            <span class="invalid-feedback block">{{ $message }}</span>
                                                            @enderror
                                                            <span class="input-group-addon">X</span>
                                                            <input type="number" name="height" id="height" class="form-control" placeholder="Height (cm)" value="{{ old('height', $productDetail->height) }}"/>
                                                            @error('height')
                                                            <span class="invalid-feedback block">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="qty_per_box" id="qty_per_box" value="{{ old('height', $productDetail->qty_per_box) }}">
                                                            @error('qty_per_box')
                                                            <div class="invalid-feedback block">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="number" name="weight_per_box" id="weight_per_box" value="{{ old('height', $productDetail->weight_per_box) }}">
